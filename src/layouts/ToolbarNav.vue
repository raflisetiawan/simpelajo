...
<template>
  ...
  ">
    ...
    <q-btn flat dense label="Beranda" :class="$q.screen.gt.xs ? `q-px-md black-text` : `black-text`"
      :to="{ name: 'Home' }" />
    <q-btn flat dense label="Layanan" :class="$q.screen.gt.xs ? `q-px-md black-text` : `black-text`"
      :to="{ name: 'Services' }" />
